...
const staticData = [
    {
        id: 1,
        article_title: "Les défis éthiques de Iiintelligence artificielle",
        date: new Date(),
    },
    {
        id: 2,
        ...
        <>
            {!generateSeoArticleOpen ? <div className="py-4 pr-2 h-screen overflow-auto flex flex-col gap-4 w-full">
                ...
                <div className="flex items-center justify-between">
                    <h1 className="text-[24px] font-[600] text-[#1E1E1E]">Articles </h1>
                    <button
                        ...
                        <div className="px-5 w-full">
                            <thead>
                                <tr className="text-left text-[#5A687C] text-[16px]">
                                    <th className="px-[14px] py-[14px] min-w-[200px] max-w-[50%] w-full font-[400] whitespace-nowrap">Article Title</th>
                                    <th className="px-[14px] py-[14px] min-w-[200px] max-w-[50%] w-full font-[400] whitespace-nowrap">Date</th>
                                                    ...
                                                    {activeDropdown === index && (
                                                        <div className="absolute right-6 px-2 w-52 rounded-md shadow-lg bg-white ring-1 ring-gray-300 ring-opacity-5 z-[10]">
                                                            <div className="py-1">
                                                                ...
                                                                >
                                                                    <div className="flex items-center gap-2"><div className='group-hover:hidden'><DownloadIcon /></div> <div className='hidden group-hover:block'><DownloadIcon status={true} /></div> <span>Download HTML File</span> </div>
                                                                </button>
