            ...
            <div className="h-full overflow-auto flex pb-2 flex-col">
                {message ? <p>{message}</p> : <div className="flex bg-white h-full rounded-2xl border-[#E1E4EA] border">
                    ...
                    <div className="w-[372px] bg-[#FFFFFF] flex flex-col rounded-l-2xl border-[#E1E4EA] border-r">
                        ...
                        <div className="w-[372px] mt-2 p-2 overflow-y-auto">
                    ...
                    {/* Main Content */}
                    {activeConversation ?
                        loadingChats ? <div className="flex justify-center items-center w-full"><span className="loader" /> </div> : <div className="flex-1 h-full flex justify-between flex-col rounded-r-2xl">
                            <>
                                {/* Header */}
                                        ...
                                        {messages.map((message) => (
                                            <div key={message.id} className="flex flex-col">
                                                ...
                                                {message.id === "typing" ? <div className="pl-[50px] pt-3 flex "><span className="three-dots" /></div> : <div
                                                    className={`max-w-[70%] w-fit text-[12px] font-[400] p-3 ${!message.isUser ? "ml-auto my-1 bg-[#675FFF] rounded-b-[10px] rounded-l-[10px] text-white" : "my-1 bg-[#F2F2F7] rounded-b-[10px] rounded-r-[10px] text-[#5A687C]"
                                                        }`}
                                                >
                            ...
                            <div className="w-full max-w-3xl mx-auto p-2">
                                <form onSubmit={handleSendMessage} className="flex w-full flex-col items-center gap-2 p-2 rounded-2xl border border-gray-300 shadow-sm">
                                    <input
                                        type="text"
