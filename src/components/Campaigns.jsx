    ...
    return (
        <div className="bg-white rounded-lg shadow-lg p-4 ">
            <div className="space-y-2 mb-4">
                {days.map((day) => (
                    <div key={day} onClick={() => toggleDay(day)} className={`p-2 rounded-lg cursor-pointer flex items-center gap-2 ${selectedDays.includes(day) ? 'bg-[#F0EFFF] text-[#675FFF]' : 'hover:bg-gray-50'}`}>
                        <div className={`w-4 h-4 rounded border flex items-center justify-center ${selectedDays.includes(day) ? 'border-[#675FFF] bg-[#675FFF]' : 'border-[#E1E4EA]'}`}>{selectedDays.includes(day) && <span className="text-white text-xs">✓</span>}</div>
                        <span>{day}</span>
                    </div>
                ))}
            </div>
            <div className="flex justify-between gap-2">
                ...
                <button onClick={onCancel} className="flex-1 border border-[#E1E4EA] py-2 px-4 rounded hover:bg-gray-50">Cancel</button>
            </div>
        </div>
    );
};
...
function CampaignsTable() {
    ...
    const calendarOptions = ["Calendly", "Google Calendar"]
            ...
            case "Visit a Page":
                return (
                    <div>
                        ...
                        <input type="text" placeholder="http:// Enter URL" className="w-full border border-[#E1E4EA] rounded-lg px-3 py-2" />
                    </div>
                )
            case "Purchase":
                return (
                ...
                <div className="bg-white max-w-[848px] w-full rounded-xl border border-[#E1E4EA] p-6 relative overflow-auto">
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="text" placeholder="Enter campaign title" className="w-full border border-[#E1E4EA] rounded-lg px-3 py-2" />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Enter main subject" className="w-full border border-[#E1E4EA] rounded-lg px-3 py-2" />
                            </div>
                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className='flex items-center gap-6'>
                                    ...
                                    <button
                                        ...
                                        className={`w-11 h-6 rounded-full relative transition-colors duration-300 ${toggleBranding ? "bg-[#7065F0]" : "bg-[#E1E4EA]"}`}
                                    >
                                        <span
                        ...
                        <div>
                            ...
                            <textarea placeholder="e.g. Write a re-engagement email for cold leads about my A1 training offer" className="w-full border border-[#E1E4EA] rounded px-3 py-2 resize-none" rows={3}></textarea>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Enter Products/Service to feature" className="w-full border border-[#E1E4EA] rounded-lg px-3 py-2" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className={`w-11 h-6 rounded-full relative transition-colors duration-300 ${toggle ? "bg-[#7065F0]" : "bg-[#E1E4EA]"}`}
                            >
                                <span
                        ...
                        <div className="flex justify-between gap-4 pt-4">
                            <button className="px-4 font-[500] w-full py-2 bg-[#675FFF] text-white rounded">Launch Campaign</button>
