...
function BalanceSheetAccounting() {
    ...
    const listedData = {
        ...
        form: { label_1: t("finn_accounting.bank_statement"), placeholder_1: t("finn_accounting.bank_statement"), label_2: t("rima.custom_instructions"), placeholder_2: t("rima.custom_instructions_placeholder") },
