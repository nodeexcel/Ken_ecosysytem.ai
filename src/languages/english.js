...
const englishTranslation = {
  ...
  ken_overview: {
    linkedin_prospection: "Linkedin Prospection",
    track_your_outreach_performance_manage_campaigns_and_measure_engagement_across_linkedin: "Track your outreach performance, manage campaigns, and measure engagement across LinkedIn.",
    your_linkedin_account: "Your LinkedIn Account",
    sami_sammari: "Sami Sammari",
    ceo_of_ecosysteme_ai: "CEO of Ecosysteme.ai",
    ...
    messages: "Messages",
    avg_invites_per_day: "Avg invites/day",
    avg_acceptances_per_day: "Avg acceptances/day",
    campaign_totals: "Campaign Totals",
    active_campaigns: "Active Campaigns",
    invitations_accepted: "Invitations Accepted",
    acceptance_rate: "Acceptance Rate",
    answered_messages: "Answered Messages",
    response_rate: "Response Rate",
    loading_accounts: "Loading accounts...",
    no_linkedin_account_connected: "No LinkedIn account connected",
    go_to_brain_ai_to_connect: "Go to Brain AI to connect your LinkedIn account.",
    go_to_brain_ai: "Go to Brain AI",
    linkedin_account: "LinkedIn Account",
    select_your_linkedin_account: "Select your LinkedIn account",
    your_connected_linkedin_account: "Your connected LinkedIn account",
    please_select_an_account_to_continue: "Please select an account to continue",
    select_your_account: "Select your account",
    continue: "Continue",
    confirm_your_login: "Confirm Your Login",
    enter_4_digit_verification_code: "Enter the 4-digit verification code we sent to",
