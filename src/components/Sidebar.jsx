...
const Sidebar = ({ isOpen, toggleSidebar, sidebarItems }) => {
  ...
  return (
    <>
      ...
      <aside className={`${isOpen && 'rounded-r-[8px] px-8 pt-3'} pl-2 ml-2 overflow-auto w-full  h-full transition-all duration-300 ${isOpen ? 'w-[120px]' : 'w-0 overflow-auto'}  flex flex-col justify-between`}>
