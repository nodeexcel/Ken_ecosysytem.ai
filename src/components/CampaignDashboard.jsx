...
function CampaignDashboard() {
    ...
    return (
        <div className="w-full p-4 flex flex-col gap-4 font-sans onest">
            ...
            <div className="overflow-auto">
                <table className="min-w-full rounded-2xl">
                    <thead>
                        <tr className="text-left text-[16px] font-[400] text-[#5A687C]">
                            <th className="px-6 py-3">Name</th>
                            <th className="px-6 py-3">Sent (date)</th>
                            <th className="px-6 py-3">Sent to (numbers)</th>
                        ...
                        {campaignData.map((item, index) => (
                            <tr key={index} className="text-center">
                                ...
                                <td className="px-6 py-4 text-sm items-center gap-2">
                                    ...
                                    <p className="relative inline-flex items-center cursor-pointer">
                                        <input
                                            type="checkbox"
