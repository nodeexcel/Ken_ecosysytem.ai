        ...
        <>
            <div className="w-full p-4 flex flex-col gap-4 onest">
                            ...
                            {campaignData.map((item, index) => (
                                <tr key={index} className={`${index !== campaignData.length - 1 ? 'border-b border-gray-200' : ''}`}>
                                    ...
                                    <td className="px-6 py-4 text-sm text-[#1E1E1E]">
                                        <div className={`px-2 py-1 w-fit border rounded-2xl ${renderColor(item.status)}`}>{item.status}</div>
                                    </td>
                                    <td className="px-6 py-4 text-sm text-[#1E1E1E] relative">
                                        ...
                                        {activeDropdown === index && (
                                            <div className="absolute right-0 w-48 rounded-md shadow-lg bg-white ring-1 ring-gray-300 z-10">
                                                <div className="py-1">
                                                    <button className="w-full text-left px-4 py-2 text-sm text-[#5A687C] hover:bg-[#F4F5F6]" onClick={() => setActiveDropdown(null)}>
                                                        <div className="flex items-center gap-2"><Notes /> <span className="hover:text-[#675FFF]">View Report</span></div>
                                                    </button>
                                                    <hr className="border-[#E6EAEE]" />
                                                    <button
                                                        className="w-full text-left px-4 py-2 text-sm text-[#FF3B30] hover:bg-[#F4F5F6]"
                                                        onClick={() => {
                                                            deleteRow(index);
                ...
                <div className="w-full border rounded-lg border-dashed border-[#C0C0C0] mt-4 p-3 flex justify-center">
                    <button className="text-[#5E54FF] bg-transparent px-6 py-2 rounded-md text-[16px] font-[500]">
                        + Add New
                    </button>
                </div>
            </div>
