    ...
    return (
        <div className="py-4 pr-2 h-screen overflow-auto flex flex-col gap-4 w-full">
            ...
            <div className="flex items-center justify-between">
                <h1 className="text-[24px] font-[600] text-[#1E1E1E]">Presentations </h1>
                <button
                    ...
                    <div className="px-5 w-full">
                        <thead>
                            <tr className="text-left text-[#5A687C] text-[16px]">
                                <th className="px-[14px] py-[14px] min-w-[200px] max-w-[35%] w-full font-[400] whitespace-nowrap">Name</th>
                                <th className="px-[14px] py-[14px] min-w-[200px] max-w-[35%] w-full font-[400] whitespace-nowrap">Status</th>
                                <th className="px-[14px] py-[14px] min-w-[200px] max-w-[35%] w-full font-[400] whitespace-nowrap">Date</th>
                    ...
                    <div className="border border-[#E1E4EA] w-full bg-white rounded-2xl p-3">
                        {loading ? <p className="flex justify-center items-center h-34"><span className="loader" /></p> :
                            presentationData.length !== 0 ?
                                                ...
                                                {activeDropdown === index && (
                                                    <div className="absolute right-6 px-2 w-52 rounded-md shadow-lg bg-white ring-1 ring-gray-300 ring-opacity-5 z-[10]">
                                                        <div className="py-1">
                                                            ...
                                                            >
                                                                <div className="flex items-center gap-2"><div className='group-hover:hidden'><EyeIcon /></div> <div className='hidden group-hover:block'><EyeIcon status={true} /></div> <span>View</span> </div>
                                                            </button>
                                                            <button
                                                                className="block w-full group text-left px-4 hover:rounded-lg py-2 text-sm text-[#5A687C] hover:text-[#675FFF] hover:bg-[#F4F5F6] font-[500]"
                                                                onClick={() => {
                                                            ...
                                                            >
                                                                <div className="flex items-center gap-2"><div className='group-hover:hidden'><DownloadIcon /></div> <div className='hidden group-hover:block'><DownloadIcon status={true} /></div> <span>Download</span> </div>
                                                            </button>
                                ...
                                </tbody> : <p className="flex justify-center items-center h-34 text-[#1E1E1E]">No Articles Listed</p>}
                    </div>
                </table>
            </div>
        </div>
