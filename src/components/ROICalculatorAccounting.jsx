...
function ROICalculatorAccounting() {
    ...
    const listedData = {
        ...
        form: { label_1:t("finn_accounting.financial_data"), placeholder_1:t("finn_accounting.financial_data"), label_2: t("rima.custom_instructions"), placeholder_2: t("rima.custom_instructions_placeholder") },
