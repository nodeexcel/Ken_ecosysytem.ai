  ...
  return (
    ...
    <div className="p-4 flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Credit Panel */}
        <div className="w-full lg:w-[360px] rounded-2xl border border-gray-200 bg-white shadow  flex flex-col justify-between">

          <div className="flex items-center justify-between bg-[#E1E4EA] px-5 py-4 rounded-t-lg">
