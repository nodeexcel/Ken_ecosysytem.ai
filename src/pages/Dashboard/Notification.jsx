...
const NotificationsComponent = ({setNotification}) => {
  ...
  return (
    <div className="flex flex-col  w-[512px] items-start bg-white rounded-xl overflow-hidden border border-solid border-[#e1e4ea] absolute z-50 left-22 top-15 h-[80%] overflow-auto">
      {/* Header */}
