                ...
                <div className='flex flex-col'>
                    ...
                    <div className='text-xl flex justify-center py-4' onClick={() => handleSelect(sidebarItems[0].id)}>
                        <svg width="44" height="32" viewBox="0 0 44 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M13.6667 19.3327C13.6667 18.4122 14.4129 17.666 15.3333 17.666H18.6667C19.5871 17.666 20.3333 18.4122 20.3333 19.3327V22.666C20.3333 23.5865 19.5871 24.3327 18.6667 24.3327H15.3333C14.4129 24.3327 13.6667 23.5865 13.6667 22.666V19.3327Z" stroke={renderColor(0)} stroke-width="1.25" stroke-linejoin="round" />
                            <path d="M23.6667 19.3327C23.6667 18.4122 24.4129 17.666 25.3333 17.666H28.6667C29.5871 17.666 30.3333 18.4122 30.3333 19.3327V22.666C30.3333 23.5865 29.5871 24.3327 28.6667 24.3327H25.3333C24.4129 24.3327 23.6667 23.5865 23.6667 22.666V19.3327Z" stroke={renderColor(0)} stroke-width="1.25" stroke-linejoin="round" />
                        </svg>
