...
export default function OutBoundCalls() {
        ...
        return agents.filter((agent) => {
            ...
            if (searchQuery) {
                ...
                const matchesSearch = 
                    ...
                    agent.recipient_no?.toLowerCase().includes(query) ||
    ...
    }, [agents, searchQuery, filters.campaign, startDate, endDate]);
        ...
        <div className="p-12 h-screen overflow-auto flex flex-col gap-4 w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
            <div className="flex flex-col gap-1">
              <h1 className="text-[22px] font-[500] text-[#1E1E1E]">{t("phone.outbound_calls")}</h1>
              <p className="text-sm md:text-[14px] text-[#5A687C] font-[400] mt-2">{t("phone.track_all_outbound_call_activities_across_your_campaigns") || "Track all outbound call activities across your campaigns."}</p>
            </div>
            {/* <button
                        ...
                        <td colSpan="9" className="text-center py-8">
                          <div className="flex flex-col items-center justify-center text-center">
                            ...
                            <button 
                              ...
                              className="px-4 py-2 bg-[#7065F0] text-white rounded-lg hover:bg-[#5A52E5] cursor-pointer"
                            >
                              Retry
                            </button>
                          </div>
