...
function ContentCreationCalender() {
 ...
 return (
  <div className="w-full p-4 flex flex-col gap-4  scrollbar-hide overflow-auto h-screen">
    {!showCreatePost && (
      <>
        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-[10px] w-full md:max-h-[59px] mb-4">
          <div className="flex flex-col gap-[10px]">
            ...
            <p className="font-[400] text-[16px] leading-tight text-[#5A687C]">
              {t("constance.scheduler_para")}    
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-[10px] h-auto sm:h-[34px] w-full sm:w-auto">
            <div className="w-full sm:w-[158px] h-[34px] rounded-[8px] border border-[#0000000D] flex p-[1px] gap-[4px] bg-[#F2F2F3]">
              <button
    ...
    `}
            ...
            <button
              ...
              className="w-full sm:w-[146px] h-[38px] sm:h-full cursor-pointer bg-[#675FFF] rounded-[8px] border-[1px] border-[#5F58E8] px-[10px] py-[6px] flex flex-row items-center justify-center gap-[8px] text-white whitespace-nowrap"
            >
